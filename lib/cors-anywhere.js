...
function getHandler(options, proxy) {
  ...
  return function (req, res) {
    ...
    if (!location) {
      ...
      if (req.url === '/') {
          // Return 404 Not Found instead of help text for the root path
          console.log('[cors-anywhere] Root path access detected, returning 404.'); // Optional log
      ...
      // showUsage(corsAnywhere.helpFile, cors_headers, res); // We replaced the call to showUsage
      return;
    }
